...
//
TCHAR WheatyExceptionReport::m_szLogFileName[MAX_PATH] = {0};
TCHAR WheatyExceptionReport::m_szDumpFileName[MAX_PATH] = {0};
LPTOP_LEVEL_EXCEPTION_FILTER WheatyExceptionReport::m_previousFilter;
HANDLE WheatyExceptionReport::m_hReportFile = NULL;
HANDLE WheatyExceptionReport::m_hProcess = NULL;;
HANDLE WheatyExceptionReport::m_hDumpFile = NULL;
...
LONG WINAPI WheatyExceptionReport::WheatyUnhandledExceptionFilter(PEXCEPTION_POINTERS pExceptionInfo )
{
    ...
    sprintf(m_szLogFileName, "%s\\%s_[%u-%u_%u-%u-%u].rpt",
            crash_folder_path, pos, systime.wMonth, systime.wDay, systime.wHour, systime.wMinute, systime.wSecond);
...
// values.
//////////////////////////////////////////////////////////////////////////////
bool WheatyExceptionReport::FormatSymbolValue(PSYMBOL_INFO pSym,STACKFRAME64 * sf,char * pszBuffer,unsigned /*cbBuffer*/)
{
...
//////////////////////////////////////////////////////////////////////////////
char * WheatyExceptionReport::DumpTypeIndex(char * pszCurrBuffer,DWORD64 modBase,DWORD dwTypeIndex,unsigned nestingLevel,DWORD_PTR offset,bool & bHandled,char* Name,char* suffix)
{
    bHandled = false;
...
char * WheatyExceptionReport::FormatOutputValue( char * pszCurrBuffer,BasicType basicType,DWORD64 length,PVOID pAddress )
{
    __try
    {
